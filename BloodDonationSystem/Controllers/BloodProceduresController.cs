...
namespace BloodDonationSystem.Controllers
{
    ...
    public class BloodProceduresController(IBloodProcedureService _service) : ControllerBase
    {
        ...
        [Authorize(Roles = "Staff")]
        [HttpPut("api/blood-registrations/{id}/blood-procedures/qualify")]
        public async Task<IActionResult> UpdateBloodQualification(int id, [FromBody] RecordBloodQualification request)
        {
